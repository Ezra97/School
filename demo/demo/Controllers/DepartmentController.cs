...
namespace demo.Controllers
{
    public class DepartmentController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "DepartmentID,InstructorID,DepartmentName")] Department department)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "DepartmentID,InstructorID,DepartmentName")] Department department)
        {
            if (ModelState.IsValid)
            {
